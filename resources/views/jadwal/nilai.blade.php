      ...
      <tr>
        ...
        <td class="align-top p-2 border border-gray-300">
          ...
          <div class="flex flex-col gap-1">
            ...
            <div class="{{ $v->itemSoal->corrects[$key]?'font-bold':'' }} flex flex-wrap items-start gap-2">{!! $key.'.
          ...
          <div class="flex justify-between gap-5 relative">
            ...
            <div class="flex flex-col gap-2 relative">
              ...
              @foreach ($v->itemSoal->relations as $key => $o)
              @if (!is_array($o))
              <div class="py-1 px-2 rounded-md text-center shadow-md border border-gray-300" x-ref='endA{{ $k.$key }}'>
                {!!
                shortcode($v->itemSoal->options[$key]) !!}</div>
              @endif
              @endforeach
